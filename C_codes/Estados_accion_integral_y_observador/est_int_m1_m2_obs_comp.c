...
void imprimirSalidaConsola_x_y(){
	...
	char* nombre_x_y_obs;
	if(tipo_control == 1) {
		nombre_x_y_obs = "Prueba_x_y_obs.txt";
	}
	else{
...
void imprimirPotencia_x_y(){
	...
	char* nombre_x_y_obs;
	if(tipo_control == 1) {
		nombre_x_y_obs = "Potencia_x_y_obs.txt";
	}
	else{
	...
	char* plot_x_y_obs;
	if(tipo_control == 1) {
		plot_x_y_obs = "plot_pot_x_y_obs.png";
	}
	else{
